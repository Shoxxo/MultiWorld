		...
		if (n != null) {
			...
			try {
				...
				if (!(rs.isBeforeFirst())) {
					...
					sql.queryUpdate(
							"INSERT INTO worlds (worlds, owner, locked, type, spawnx, spawny, spawnz, spawnyaw, spawnpitch) VALUES ('" + name + "', '" + owner + "', '" + locked + "', '" + type + "', '" + spawnX + "', '" + spawnY + "', '" + spawnZ + "', '" + spawnYaw + "', '" + spawnPitch + "')");
				} else {
