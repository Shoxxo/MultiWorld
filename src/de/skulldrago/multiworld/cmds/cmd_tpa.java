                    ...
                    if (target != null) {
                        if (cfg2.contains("Commands.Tpa.Message")) {
                            ...
                            target.sendMessage("§c" + p.getName()
                                    + " hat dir eine Teleportanfrage geschickt. Um zu akzeptieren benutze /tpaccept. Um ab zu lehnen benutze /tpadeny.");
                        }
                        ...
                        sql.queryUpdate("INSERT INTO tprequests (name, requestname) VALUES ('" + target.getName()
                                + "', '" + p.getName() + "')");
