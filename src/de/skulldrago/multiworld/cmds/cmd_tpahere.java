                ...
                if (args.length == 1) {
                    ...
                    if (target != null) {
                        if (cfg2.contains("Commands.Tpahere.Message")) {
                            ...
                            target.sendMessage("§c" + p.getName()
                                    + " hat dir eine Teleportanfrage geschickt. Um zu akzeptieren benutze /tpahereaccept. Um ab zu lehnen benutze /tpaheredeny.");
                        }
                        ...
                        sql.queryUpdate("INSERT INTO tphererequests (requestname, name) VALUES ('" + p.getName()
                                + "', '" + target.getName() + "')");
